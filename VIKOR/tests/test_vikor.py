...
from ..src.vikor_cin import vikor_decision_support
...
def test_vikor_decision_success() -> None:
    """
    ...
    """
    results = vikor_decision_support(VALID_INPUT)
...
def test_vikor_missing_parameters() -> None:
    """
    ...
    with pytest.raises(ValueError):
        vikor_decision_support(incomplete_input)

def test_vikor_incorrect_performance_matrix() -> None:
    """
    ...
    with pytest.raises(ValueError):
        vikor_decision_support(bad_perf_input)

def test_vikor_invalid_criteria_type() -> None:
    """
    ...
    with pytest.raises(ValueError):
        vikor_decision_support(bad_type_input)
